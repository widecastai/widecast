...
> **Step 3 (audit layout with `scene_geometry`) and Step 4 (the 5 A-roll layout scenarios) → `ai_video_editor/10_mechanics`.** Then the per-scene visual work: background → `20_background`; overlay → `30_overlay_core` (+ the matching style module).
