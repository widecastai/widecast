...
Thickness/stroke check: <PASS|FAIL> — body is thick via 900-equivalent font or approved offset-face recipe; visible text stroke is <=2px, thin/controlled, not over-stroked
...
Screenshot check: <PASS|FAIL> — title matches the approved copy, has no visible typo/grammar/diacritic error, and is readable, prominent, 900-weight/thick-bodied, open typography (not boxed in a card/panel), thin-outlined <=2px/not over-stroked, and stronger than labels
