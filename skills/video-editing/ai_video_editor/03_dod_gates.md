...
Face-stack count: <8–18 copies> — same-fill copies inside the same title object; state why this count fits the font/word length
...
Thickness/stroke check: <PASS|FAIL> — body is thick via 900-equivalent font + 8–18x face stack; visible text stroke is <=2px, thin/controlled, not over-stroked
