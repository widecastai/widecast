...
def _write_skill_load_manifest(folder) -> None:
    ...
    lines = [
        ...
        "After loading any module below, its actual line count + last non-empty line "
        "+ sha256 MUST match its row here (see the LOAD LEDGER in SKILL.md / "
        "ai_video_editor/03_dod_gates). A mismatch = truncated/stale = NOT loaded; "
        "re-read to EOF before acting.",
        "",
