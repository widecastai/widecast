...
| [`/v1/error/report`](endpoints/error-report.html) | POST | (sync, free) Report a WideCast problem to the WideCast team — `error_message` (+ optional `module`, `context`). Not a user-notification channel |
