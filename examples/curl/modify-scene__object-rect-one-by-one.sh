...
curl -X POST "https://widecast.ai/app/dashboard/v1/modify_scene" \
  ...
  -d '{"id": "widecast7c0d4f8a9b1e2d3f", "by": "voice_file", "value": "XcR0k", "fields": [{"field_name": "remotion.object.rect", "value": {"layout_id": "main.one_by_one", "x": 24, "y": 140, "w": 232, "h": 42, "coordinate_space": "preview"}}]}'
