  ...
  "script": {
    ...
    "segments": [
      ...
      },
      {
        "id": 2,
        "type": "BODY",
        "text": "First, draft your script — bullet points work fine.",
        "language": "en"
      },
      {
        "id": 3,
        "type": "BODY",
        "text": "Second, paste it into WideCast and pick an aspect ratio.",
        "language": "en"
      },
      {
        "id": 4,
        "type": "BODY",
        "text": "Third, hit render and grab a coffee — done in under a minute.",
        "language": "en"
      },
      {
        "id": 5,
