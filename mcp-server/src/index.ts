...
const TOOLS = [
  ...
  },
  {
    ...
    description:
      "Edit ONE scene of an existing video in place. SYNCHRONOUS, **NO credit charged** until widecast_export_video re-renders the final MP4. Successful edits publish MQTT realtime to every open scene editor, so the user sees the change live.\n" +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        fields: {
          ...
          minItems: 1,
          description:
            "Edits to apply. Pick exactly ONE family per call — do not mix.\n" +
  ...
  },
  {
    ...
    description:
      "Read structured video/scene data for a topic_id. SYNC, FREE. **First step for data-first scene audit/edit** — call this before widecast_modify_scene or widecast_scene_inspector. " +
  ...
  },
  {
    ...
    description:
      "SYNC live browser inspector for an open scene editor of a video. Use this **only after** data-first audit with widecast_video_data, when the agent specifically needs BROWSER TRUTH (mounted DOM, computed boxes, preview play state, a small 280×498 screenshot) — not what's stored in ES. " +
